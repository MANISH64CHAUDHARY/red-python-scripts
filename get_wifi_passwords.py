...
#      Python allows to run system commands using the function
...
#      a group of all characters until the return escape sequence (\r)
#      appears.
...
#     have not been found. So we run this part to check the
...
if len(profile_names) != 0:
    for name in profile names:
        ...
        #    We use the regular expression to only look for the absent cases
        ...
        if re.search("Security key           : Absent", profile_info):
            ...
            if password == None:
                ...
                #    that we are interested in to the password key in the
                #    dictionary.
